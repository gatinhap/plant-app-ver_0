...
const Form = () => {
    ...
    const [singlePlant, setSinglePlant] =
        useState(initialFormData.plants[0])
    ...
    return (
        <>
            ...
            <StyledForm onSubmit={handleSubmit}>
                ...
                <div>
                    <LabelField>dodaj jej zdjęcie
                        <InputField
                            height={'190px'}
                            placeholder={'zalecane wymiary to min. 250px na 200px, format png  lub jpg'}
                            type={'file'}
            ...
            <p style={{color: Color.cream}}>To check if data is correctly received. For now it's not really working. The
